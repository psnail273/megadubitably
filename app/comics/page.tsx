        ...
        <div className="flex flex-col items-center gap-8 w-full">
          <div className="flex flex-col items-center gap-8 mx-4">
            ...
            <Image 
              ...
              alt="Cottonwood_Title" 
              width={data['title']['width']} 
              height={data['title']['height']} 
              loading="eager"
            />
            <div className="font-open-sans-light text-[#6D6D6D] text-center max-w-[100ch]">
          ...
          <div className="flex flex-col items-center gap-4 mx-4">
            <Image 
              src={data['awards']['image']} 
              alt="Cottonwood_Awards" 
              width={data['awards']['width']} 
              height={data['awards']['height']} 
              loading='lazy'
            />
            <Image 
              src={data['leaf']['image']} 
              alt="Cottonwood_Leaf" 
              width={data['leaf']['width']} 
              height={data['leaf']['height']} 
              loading='lazy'
            />
            <div className="font-open-sans-light text-[#6D6D6D] text-center max-w-[100ch]">
