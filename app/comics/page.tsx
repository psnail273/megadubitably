        ...
        <div className="flex flex-col items-center gap-8 w-full">
          <div className="flex flex-col items-center gap-8 mx-4">
            ...
            <div className="font-open-sans-light text-[#6D6D6D] text-center max-w-[100ch]">
              ...
              This project was a little ambitious for my first comic book, but over eight years later we published it via a successful Kickstarter campaign, which you can view by clicking <a href="https://www.kickstarter.com/projects/250303295/under-the-cottonwood-tree-a-latinx-fairy-tale-adve" target="_blank" rel="noopener noreferrer" className="text-[#939BBA] hover:underline underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#939BBA] font-bold rounded">here</a>.
              <br />
              <br />
              You can purchase the book via this <a href="https://www.underthecottonwoodtree.com/#buy_now" target="_blank" rel="noopener noreferrer" className="text-[#939BBA] hover:underline underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#939BBA] font-bold rounded">link</a>.
              <br />
              <br />
            ...
            <div className="flex flex-col max-w-[1400px]">
              {data['pages']['images'].map((image) => (
                <Image 
                  key={image} 
                  src={image} 
                  alt="Cottonwood_Page" width={data['pages']['width']} height={data['pages']['height']} className="w-full h-auto" priority />
              ))}
            </div>
          </div>
          <div className="flex flex-col items-center gap-4 mx-4">
            <Image src={data['awards']['image']} alt="Cottonwood_Awards" width={data['awards']['width']} height={data['awards']['height']} priority />
            <Image src={data['leaf']['image']} alt="Cottonwood_Leaf" width={data['leaf']['width']} height={data['leaf']['height']} priority />
            <div className="font-open-sans-light text-[#6D6D6D] text-center max-w-[100ch]">
